package com.whaleal.aihub.network;
 ...
 * via the system property {@code -Daihub.ssl.trust-all=true}. Without this property,
...
public class OkHttpUtil {
    ...
    public static final String TRUST_ALL_PROPERTY = "aihub.ssl.trust-all";
     ...
     *
     * @return {@code true} if {@code -Daihub.ssl.trust-all=true} is set
     */
     ...
     * @throws IllegalStateException    if {@code -Daihub.ssl.trust-all=true} is not set
