package com.whaleal.aihub.platform.ollama.chat;
...
import com.whaleal.aihub.platform.ollama.chat.entity.OllamaChatCompletion;
import com.whaleal.aihub.platform.ollama.chat.entity.OllamaChatCompletionResponse;
import com.whaleal.aihub.platform.ollama.chat.entity.OllamaMessage;
import com.whaleal.aihub.platform.ollama.chat.entity.OllamaOptions;
import com.whaleal.aihub.platform.openai.chat.entity.*;
import com.whaleal.aihub.platform.openai.chat.entity.*;
import com.whaleal.aihub.platform.openai.chat.enums.ChatMessageType;
...
public class OllamaAiChatService implements IChatService, ParameterConvert<OllamaChatCompletion>, ResultConvert<OllamaChatCompletionResponse> {
    ...
    public EventSourceListener convertEventSource(SseListener eventSourceListener) {
        ...
        return new EventSourceListener() {
            ...
            public void onEvent(@NotNull EventSource eventSource, @Nullable String id, @Nullable String type, @NotNull String data) {
                ...
                OllamaChatCompletionResponse ollamaChatCompletionResponse = Jsons.fromJson(data, OllamaChatCompletionResponse.class);
    ...
    private void sendConvertedResponse(SseListener listener, EventSource eventSource, String id, String type, ChatCompletionResponse response) {
        listener.onEvent(eventSource, id, type, Jsons.toJson(response));
    }
...
/*        // 如含有function，则添加tool
        ...
        while("first".equals(finishReason) || "tool_calls".equals(finishReason)){
            ...
            String requestString = toOllamaRequestJson(ollamaChatCompletion);
            ...
            if (execute.isSuccessful() && execute.body() != null){
                OllamaChatCompletionResponse ollamaChatCompletionResponse = Jsons.fromJson(execute.body().string(), OllamaChatCompletionResponse.class);
...
/*        // 如含有function，则添加tool
    ...
    /**
     * extraBody 已由 {@code @JsonAnyGetter} 摊到顶层；这里只把 tool_calls.function.arguments 从字符串转成对象。
     */
    private String toOllamaRequestJson(OllamaChatCompletion ollamaChatCompletion) {
        JsonNode rootNode = Jsons.mapper().valueToTree(ollamaChatCompletion);
        if (!rootNode.isObject()) {
            return Jsons.toJson(ollamaChatCompletion);
        }
            ...
            for (JsonNode message : messagesNode) {
                ...
                for (JsonNode toolCall : toolCalls) {
                    ...
                    if (arguments != null && arguments.isTextual()) {
                        function.set("arguments", Jsons.readTree(arguments.asText()));
                    }
                }
            }
        }
