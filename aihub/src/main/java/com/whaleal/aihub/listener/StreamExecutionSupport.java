...
public final class StreamExecutionSupport {
    ...
    public static final String DEFAULT_FIRST_TOKEN_TIMEOUT_PROPERTY = "aihub.stream.default.first-token-timeout-ms";
    public static final String DEFAULT_IDLE_TIMEOUT_PROPERTY = "aihub.stream.default.idle-timeout-ms";
    public static final String DEFAULT_MAX_RETRIES_PROPERTY = "aihub.stream.default.max-retries";
    public static final String DEFAULT_RETRY_BACKOFF_PROPERTY = "aihub.stream.default.retry-backoff-ms";
