...
public class HttpErrorDecoderTest {
    ...
    @Test
    public void allExceptionsExtendAihubException() {
        assertTrue(new AiAuthException(401, "msg") instanceof AihubException);
        assertTrue(new AiClientException(400, "msg") instanceof AihubException);
    }
