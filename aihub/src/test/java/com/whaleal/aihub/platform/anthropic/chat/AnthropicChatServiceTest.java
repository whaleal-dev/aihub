...
public class AnthropicChatServiceTest {
    ...
    public void shouldTranslateAnthropicStreamToOpenAiChunks() {
        ...
        Map<String, Object> firstTextChunk = Jsons.fromJson(capture.forwarded.get(0), Map.class);
        ...
        Map<String, Object> finishChunk = Jsons.fromJson(
    ...
    public void shouldTranslateToolUseStreamToToolCallChunk() {
        ...
        Map<String, Object> toolChunk = Jsons.fromJson(toolChunkJson, Map.class);
        @SuppressWarnings("unchecked")
