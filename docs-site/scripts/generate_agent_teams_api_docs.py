...
SOURCE_ROOT = REPO_ROOT / "aihub-agent" / "src" / "main" / "java" / "com" / "whaleal" / "aihub" / "agent" / "team"
...
def render_markdown(classes: List[ClassInfo]) -> str:
    ...
    lines.extend(
        [
            ...
            "",
            "本页覆盖 `com.whaleal.aihub.agent.team` 与 `com.whaleal.aihub.agent.team.tool` 包中所有源码类，",
